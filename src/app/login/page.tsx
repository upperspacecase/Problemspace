...
export default function LoginPage() {
  ...
  if (!configured) {
    return (
      <div className="max-w-sm mx-auto mt-20 text-center">
        <h1 className="text-xl font-serif text-text-primary mb-3">Log in</h1>
  ...
  return (
    <div className="max-w-sm mx-auto mt-20">
      <h1 className="text-xl font-serif text-text-primary mb-6 text-center">Log in</h1>
      ...
      <div className="card p-6">
        ...
        <form onSubmit={handleEmailLogin} className="space-y-3">
          ...
          <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required className="input-base" placeholder="Password" />
